  ...
  return (
    ...
    >
      <div className="w-full max-w-[420px] flex flex-col shadow-2xl"
        ...
        {/* Header */}
        <div className="px-5 pt-3 pb-4 flex-shrink-0" style={{ borderBottom: '1px solid #1a1919' }}>
          <div className="flex items-center justify-between mb-5">
            <h2 className="font-headline font-black text-3xl tracking-tighter uppercase text-white leading-none">
              ¿EN QUÉ<br/><span style={{ color: '#ff5e07' }}>COLECTIVO?</span>
            </h2>
          ...
          <div className="relative">
            <svg className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4" style={{ color: '#adaaaa' }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        {!selectedLine && (
          <ul className="overflow-y-auto flex-1">
            {filtered.length === 0 && (
              <li className="px-5 py-10 text-center text-sm" style={{ color: '#adaaaa' }}>
            ...
            {filtered.map((line) => (
              <li key={line.number} style={{ borderBottom: '1px solid rgba(255,255,255,0.03)' }}>
                <button
                  ...
                  onMouseEnter={(e) => (e.currentTarget.style.background = 'rgba(255,94,7,0.05)')}
                ...
                >
                  ...
                  <div className="min-w-0 flex-1" style={{ borderLeft: '2px solid #1a1919', paddingLeft: '16px' }}>
                    <span className="text-sm text-white font-bold font-headline uppercase tracking-tight">{line.name}</span>
                    <p className="text-xs mt-0.5 truncate" style={{ color: '#adaaaa' }}>
                      {line.branches.length} ramal{line.branches.length !== 1 ? 'es' : ''}
                    </p>
                  </div>
                  <svg className="w-4 h-4 flex-shrink-0" style={{ color: '#adaaaa' }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        {selectedLine && !selectedBranch && (
          <div className="flex flex-col flex-1 overflow-hidden">
            <button
              ...
              style={{ color: '#ff9064', borderBottom: '1px solid #1a1919' }}
            >
            ...
            <p className="px-5 py-2 text-xs uppercase font-headline font-bold tracking-widest" style={{ color: '#adaaaa' }}>Seleccioná el ramal:</p>
            <ul className="overflow-y-auto flex-1">
                ...
                <li key={branch.id} style={{ borderBottom: '1px solid rgba(255,255,255,0.03)' }}>
                  ...
                  >
                    <div className="w-8 h-8 rounded-xl flex items-center justify-center flex-shrink-0"
                      style={{ background: 'rgba(255,94,7,0.1)', border: '1px solid rgba(255,94,7,0.2)' }}>
                      <svg className="w-4 h-4" style={{ color: '#ff5e07' }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7" />
                      </svg>
                    </div>
                    <span className="text-sm text-white font-medium">{branch.name}</span>
                    <svg className="w-4 h-4 ml-auto flex-shrink-0" style={{ color: '#adaaaa' }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
                  </button>
                </li>
        ...
        {/* Confirmación */}
        {selectedLine && selectedBranch && (
          <div className="px-5 py-5 flex-shrink-0" style={{ borderTop: '1px solid #1a1919' }}>
            <div className="rounded-[14px] p-4 mb-4 flex items-center gap-3"
              style={{ background: 'rgba(255,94,7,0.08)', border: '1px solid rgba(255,94,7,0.2)' }}>
              ...
              <div className="min-w-0">
                <p className="text-xs font-headline font-bold uppercase tracking-widest mb-0.5" style={{ color: '#ff9064' }}>Seleccionado</p>
